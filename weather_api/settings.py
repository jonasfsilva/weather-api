...
SECRET_KEY = "django-insecure-pn0#$-o2ab4)rvw+x0c6uj@nw9goa$jpi=rhsfi+syf)nlnq^t"
...
OPENWEATHER_API_KEY = config(
    "OPENWEATHER_API_KEY", default="cd4f3e1f01e5e0e364e5df0448901d88"
)
WEATHER_URL = config(
    "WEATHER_URL", default="https://api.openweathermap.org/data/2.5/weather"
)
